...
class Predictor:
    ...
    def setup(self):
        ...
        def load_model(model_name):
            ...
            '''
            try:
                currfile_dir = os.path.dirname(os.path.abspath(__file__))
                
                wights_dir = os.path.join(currfile_dir, "../../weights")
...
if __name__ == "__main__":
    ...
    predictor.setup()
    currfile_dir = os.path.dirname(os.path.abspath(__file__))
    videofile = os.path.join(currfile_dir, "../../assets/SaaS.mp4")
    prediction = predictor.predict(videofile, model_name = "base",
                                   word_timestamps=True)
    print(prediction)
# %%